...

{
  programs.bash.shellAliases = {
    ...
    upgrade-hs = "nixos-rebuild --target-host root@192.168.0.110 switch --flake github:bvgcat/nix-config#homeserver";
    upgrade-pi = "nixos-rebuild --target-host root@192.168.0.100 switch --flake github:bvgcat/nix-config#pi3b";
    upgrade-sg = "nixos-rebuild --target-host root@192.168.0.229 switch --flake github:bvgcat/nix-config#surface-go";
  };
}
